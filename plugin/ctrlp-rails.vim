...
command! CtrlPLibs call ctrlp#init(ctrlp#libs#id())
command! CtrlPSpecs call ctrlp#init(ctrlp#specs#id())
command! CtrlPViews call ctrlp#init(ctrlp#views#id())
command! CtrlPMigrations call ctrlp#init(ctrlp#migrations#id())
